...
if ($new_user) {
  // code...
    $query = "INSERT INTO `online` (`name`,`email`,`distance`,`phoneNumber`,`tshirt_size`) VALUES ('$_POST[name]', '$_POST[email]', '$_POST[distance]', '$_POST[phone]', '$_POST[tshirt_size]');";
    ...
    // sms to client
    sendSms($_POST["phone"],"Hello .
    Thanks for registering for the Legibra Trail Run.
    Please complete your registration by paying a registration fee of KES. 2,000 using Paybill 461110. The account name is ".strtoupper($_POST["name"]).".",$connection);
    // email to organiser
    sendEmail($organiser_email1,"$_POST[name] - Legibra Trail Run Registration.","
      ...
      <ul>
        ...
        <li> <b>T-shirt size :</b> $_POST[tshirt_size] KM</li>
      </ul>
    ...
    // email to client
        sendEmail($_POST['email'],"$_POST[name] - Legibra Trail Run Registration.","<p>Dear $_POST[name].</p>
<p>Thanks for registering for the Legibra Trail Run.</p>
<p>Please complete your registration by paying a registration fee of KES. 2,000 using Paybill 461110. The account name is your full name.</p>
<p>Alternatively, click on the <a href='https://run.legibra.com/payment.html?$row[id]=$row[phoneNumber]'>link</a>  to pay online now.</p>
<p>See you at there.</p>
<img src='https://run.legibra.com/img/poster.jpg' style='width:100%'>
<p>&nbsp;</p>
<p>Regards,<br>
Sylvia Korir,<br>
Legibra Trail Run Coordinator.<br>
0735135135</p>",$connection);
...
//   </ul>
//
//   <p> Please pay a registration fee of Ksh 2,000 using mPesa PayBill 461110 and account name ".strtoupper($_POST["name"])." </p>
//
